// Code to display the list of deliveries for the courier
...
const CourierDeliveries = ({ navigation }) => {
  ...
  // Determinme the color of the status button based on the status
  ...
  // Redirect the non-courier user to the appropriate screen based on the user mode
  useEffect(() => {
  ...
  // Fetch the list of orders for the courier
  const fetchOrders = () => {
    ...
    <View style={styles.row}>
      ...
      <View style={[styles.addressColumn]}>
        <Text style={styles.orderTableText}>
          {item.customer_address.split(",")[0]}
        </Text>
        <Text style={styles.orderTableText}>
          {item.customer_address.split(",").slice(1).join(",")}
        </Text>
      </View>
      <TouchableOpacity
        style={[
    ...
    <View style={styles.container}>
      ...
      <View style={styles.container}>
        <View style={styles.subContainer}>
          <Text style={styles.headingText}>MY DELIVERIES</Text>
            ...
            <View style={styles.modalOverlay}>
              <View style={styles.modalContent}>
                ...
                <View style={styles.modalBody}>
                  <View
                    style={[styles.moddalHeaderText, globalStyles.arialNormal]}
                  >
                    <View style={styles.addressRow}>
                      ...
                      <Text style={styles.orderSumaryText}>
                        {selectedOrder
                          ? ` ${selectedOrder.customer_address.substring(
                              0,
                              selectedOrder.customer_address.indexOf(",")
                            )}\n${selectedOrder.customer_address.substring(
                              selectedOrder.customer_address.indexOf(",") + 1
                            )}`
                          : "Loading..."}
                      </Text>
                    </View>
